...
final class SiteController extends Controller
{
    ...
    public function indiqueAmigo()
    {
        ...
        <p>Isso mesmo, ele poderá acessar e usufruir de grande parte dos benefícios durante este período, conhecer melhor os benefícios de ser nosso associado.</p>
        <p>Basta colocar os dados do seu amigo, que a liberação do seu acesso será automática! Quando você indica, você também demonstra sua amizade!</p>
        <p>Lembre-se que para a liberação do acesso ocorrer, ele precisa ser da sua carreira e ainda não ser filiado à nossa entidade.</p>
        ';
        if(CLUBE_ID == '2dbd9e375eeabfbe859365dae0798f49') :
            $texto = '<p>O que você acha de liberar um acesso por 30 dias para um amigo?</p><p>Isso mesmo, ele poderá acessar e usufruir de grande parte dos benefícios durante este período, conhecer melhor os benefícios de ser nosso cliente.</p><p>Basta colocar os dados do seu amigo, que a liberação do seu acesso será automática! Quando você indica, você também demonstra sua amizade!</p>';
        elseif (CLUBE_FINALIDADE == 2):
            $texto = '<p>O que você acha de liberar um acesso por 48h para um amigo?</p><p>Isso mesmo, ele poderá acessar e usufruir de grande parte dos benefícios durante este período, conhecer melhor os benefícios de ser nosso cliente.</p><p>Basta colocar os dados do seu amigo, que a liberação do seu acesso será automática! Quando você indica, você também demonstra sua amizade!</p>';
        endif;
    ...
    public function abrirModalEnquetePopup($id = null)
    {
        return view('popup.enquete');
    }


    public function abrirModalPopupImagem($id = null)
    {

...
final class Scope
{
    public const CLUBE_INTERNO = [
        ...
        'texto_clube:listar', 'usuario_cliente:atualizar', 'usuario_cliente:buscar',
        'usuario_cliente:listar', 'usuario_cliente:salvar',
        'usuario_grupo:atualizar', 'usuario_grupo:buscar',

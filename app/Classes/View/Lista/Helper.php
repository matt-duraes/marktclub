...
final class Helper
{
    public const PARAMETROS_LISTAR = [
        'tipo', 'local', 'titulo', 'status', 'texto', 'link', 'target', 'tabela', 'editor',
        'titulo_interno', 'margem_topo', 'margem_esquerda', 'margem_direita', 'margem_baixo',
        'imagem_link', 'imagem_arquivo', 'imagem_altura', 'icone_tipo', 'icone_tamanho',
        'icone_nome', 'icone_altura', 'lista_tipo', 'lista_valor', 'link_empresa', 'div_direcao',

...
final class Helper
{
    public const PARAMETROS_LISTAR = [
        ...
        'icone_tipo', 'icone_tamanho', 'icone_nome', 'icone_cor', 'icone_bg', 'icone_borda_cor', 'css',
        'icone_altura', 'lista_tipo', 'lista_valor', 'link_empresa', 'api_status', 'api_metodo', 'condicao',

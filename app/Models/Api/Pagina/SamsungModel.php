            ...
            $this
                ...
                ->passoPasso(function () {
                    $this
                        ...
                        ->passoPassoItem(
                            icone: '<svg height="18" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 40 30" xml:space="preserve"><path class="st0" d="M36,0H20.8h-1.7H4C1.8,0,0,1.7,0,3.8v22.5C0,28.3,1.8,30,4,30h10.9h4H36c2.2,0,4-1.7,4-3.8V3.8 C40,1.7,38.2,0,36,0z M4,2.6h15.2h1.7H36c0.1,0,0.2,0,0.3,0L20,14.8L3.6,2.7C3.7,2.7,3.8,2.6,4,2.6z M37.2,26.2 c0,0.6-0.5,1.1-1.2,1.1H18.9h-4H4c-0.6,0-1.2-0.5-1.2-1.1V5.4l16.4,12.1c0,0,0,0,0,0v0c0.1,0,0.1,0.1,0.2,0.1c0.1,0,0.1,0.1,0.2,0.1 c0.1,0,0.3,0.1,0.4,0.1c0,0,0,0,0,0s0,0,0,0c0.1,0,0.3,0,0.4-0.1c0.1,0,0.1-0.1,0.2-0.1c0.1,0,0.1-0.1,0.2-0.1v0c0,0,0,0,0,0 L37.2,5.4V26.2z"></path></svg>',

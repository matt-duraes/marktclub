...
<body>
    <br>
    <hr style="height: 2px; background-color: #caaa00; border: none">
    <br>
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td width="120" style="width: 120px;">
                <img src="https://youhuul.com.br/images/assinatura/youhuul.png?cache=123" width="120"></td>
            </td>
            ...
            <td style="width: calc(100% - 150px);">
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tr>
                        <td style="padding: 3px 0 3px 8px; border-width:0px 0px 0px 3px;border-style:none none none solid;border-color:rgb(187,187,187) rgb(187,187,187) rgb(187,187,187) #caaa00; font-family: Arial, Helvetica, sans-serif; color: #666; font-size: 14px">
                            {{TELEFONE}}
                        </td>
                    </tr>
                    <tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
            <td style="padding: 3px 0; font-family: Arial, Helvetica, sans-serif; color: #333; font-size: 11px">
                <a href="https://www.google.com.br/maps/place/You+Huul/@-15.7873053,-47.9154213,17z/data=!3m1!4b1!4m5!3m4!1s0x935a3afcad18a7af:0xe00941a34d1204a6!8m2!3d-15.7873053!4d-47.9132326" target="_blank"><img src="https://youhuul.com.br/images/assinatura/mapa.png" height="25"></a>
            </td>
        </tr>
    </table>
        ...
        <tr>
            <td>
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td width="25">
                            <a href="https://www.instagram.com/youhuul" target="_blank"><img src="https://youhuul.com.br/images/assinatura/instagram.png" width="25" alt=""></a>
                        </td>
                        <td width="5"></td>
                        <td width="25">
                        ...
                        <td width="5"></td>
                        <td width="25">
                            <a href="https://www.linkedin.com/company/youhuul/" target="_blank"><img src="https://youhuul.com.br/images/assinatura/linkedin.png" width="25" alt=""></a>
                        </td>
                        <td></td>
                    </tr>
                </table>

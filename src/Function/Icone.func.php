...
if (!function_exists('iconeTv')) {
    ...
    {
        return '<svg height="' . $tamanho . '" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 24.1 24" xml:space="preserve"><path d="M16.1,4.8h6.7c0.7,0,1.2,0.5,1.2,1.2v16.8c0,0.7-0.5,1.2-1.2,1.2H1.2C0.5,24,0,23.5,0,22.8c0,0,0,0,0,0V6c0-0.7,0.5-1.2,1.2-1.2h6.7L4.9,1.7L6.6,0l4.8,4.8h1.4L17.5,0l1.7,1.7L16.1,4.8z M2.4,7.2v14.4h19.2V7.2H2.4z"/></svg>';
    }
}
if (!function_exists('iconeTablet')) {
    ...
    {
        return '<svg height="' . $tamanho . '" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 19.2 24" xml:space="preserve"><path d="M2.4,2.4v19.2h14.4V2.4H2.4z M1.2,0H18c0.7,0,1.2,0.5,1.2,1.2v21.6c0,0.7-0.5,1.2-1.2,1.2H1.2C0.5,24,0,23.5,0,22.8V1.2C0,0.5,0.5,0,1.2,0z M9.6,18c0.7,0,1.2,0.5,1.2,1.2c0,0.7-0.5,1.2-1.2,1.2c-0.7,0-1.2-0.5-1.2-1.2C8.4,18.5,8.9,18,9.6,18z"/></svg>';
    }
}
if (!function_exists('iconeTelefone')) {
     ...
     * @return string SVG do icone
     */
    function iconeTelefone(int $tamanho = 18): string
    {
        return '<svg height="' . $tamanho . '" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 20 20" xml:space="preserve"><path d="M7.1,8.5c1,1.8,2.6,3.4,4.4,4.4l1-1.4c0.3-0.5,0.9-0.6,1.4-0.3c1.6,0.9,3.3,1.4,5.1,1.5c0.6,0,1,0.5,1,1.1v5c0,0.6-0.4,1-1,1.1C18.4,20,17.8,20,17.2,20C7.7,20,0,12.3,0,2.8C0,2.2,0,1.6,0.1,1c0.1-0.6,0.5-1,1.1-1h5c0.6,0,1.1,0.4,1.1,1c0.1,1.8,0.7,3.5,1.5,5.1C9,6.6,8.9,7.2,8.4,7.6L7.1,8.5z M4.3,7.8l2.1-1.5C5.8,5,5.4,3.6,5.2,2.2H2.2c0,0.2,0,0.4,0,0.6c0,8.3,6.7,15,15,15c0.2,0,0.4,0,0.6,0v-2.9c-1.4-0.2-2.8-0.6-4.1-1.2l-1.5,2.1c-0.6-0.2-1.2-0.5-1.8-0.8l-0.1,0c-2.2-1.2-4-3-5.2-5.2l0-0.1C4.8,9,4.5,8.4,4.3,7.8z"/></svg>';
    }
}
if (!function_exists('iconeCelular')) {
    // doc
    // exemplo
    // echo iconeCelular
    /**
     * Gera um icone de celular
     *
     * @param  int    $tamanho Altura do atributo height do svg
     * @return string SVG do icone
     */
    function iconeCelular(int $tamanho = 20): string
    {
        return '<svg height="' . $tamanho . '" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 14 20" xml:space="preserve"><path d="M2,2v16h10V2H2z M1,0h12c0.6,0,1,0.4,1,1v18c0,0.6-0.4,1-1,1H1c-0.6,0-1-0.4-1-1V1C0,0.4,0.4,0,1,0z M7,15c0.6,0,1,0.4,1,1s-0.4,1-1,1s-1-0.4-1-1S6.4,15,7,15z"/></svg>';
    }
}
if (!function_exists('iconePc')) {
    ...
    {
        return '<svg height="' . $tamanho . '" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 25.3 24" xml:space="preserve"><path d="M2.5,16.4h20.2V2.5H2.5V16.4z M13.9,18.9v2.5h5.1V24H6.3v-2.5h5.1v-2.5H1.3c-0.7,0-1.3-0.6-1.3-1.3c0,0,0,0,0,0V1.3C0,0.6,0.6,0,1.3,0H24c0.7,0,1.3,0.6,1.3,1.3v16.4c0,0.7-0.6,1.3-1.3,1.3H13.9z"/></svg>';
    }
}
if (!function_exists('iconeUsuario')) {
    ...
    {
        return '<svg height="' . $tamanho . '" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 35 40" xml:space="preserve"><path class="st0" d="M21.7,23.1h-8.4c-5.5,0-10,4.5-10,10v0.2c0,1.8,1.5,3.3,3.3,3.3h21.7c1.8,0,3.3-1.5,3.3-3.3v-0.2C31.7,27.6,27.2,23.1,21.7,23.1z M13.3,19.8C6,19.8,0,25.7,0,33.1v0.2C0,37,3,40,6.7,40h21.7c3.7,0,6.7-3,6.7-6.7v-0.2c0-7.4-6-13.3-13.3-13.3H13.3z"/><path class="st0" d="M17.5,13.7c2.9,0,5.2-2.3,5.2-5.2c0-2.9-2.3-5.2-5.2-5.2c-2.9,0-5.2,2.3-5.2,5.2C12.3,11.4,14.6,13.7,17.5,13.7z M17.5,17.1c4.7,0,8.5-3.8,8.5-8.5C26,3.8,22.2,0,17.5,0S9,3.8,9,8.5C9,13.2,12.8,17.1,17.5,17.1z"/></svg>';
    }
}
...
if (!function_exists('iconeEditar')) {
    ...
    {
        return '<svg height="' . $tamanho . '" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 27 27" xml:space="preserve"><desc>Created with Sketch.</desc><g><g transform="translate(-2.000000, -2.000000)"><g><path d="M21.3,2.3c0.4-0.4,1-0.4,1.4,0l0,0l6,6c0.4,0.4,0.4,1,0,1.4l0,0l-17,17c-0.1,0.1-0.3,0.2-0.5,0.3l0,0     l-8,2c-0.7,0.2-1.4-0.5-1.2-1.2l0,0l2-8c0-0.2,0.1-0.3,0.3-0.5l0,0L21.3,2.3z M18,8.4L5.9,20.5l-1.5,6.1l6.1-1.5L22.6,13L18,8.4z M22,4.4L19.4,7l4.6,4.6L26.6,9L22,4.4z"/></g></g></g></svg>';
    }
}
...
if (!function_exists('iconeListaLista')) {
    ...
    {
        return '<svg height="' . $tamanho . '" x="0px" y="0px" viewBox="0 0 20 20" xml:space="preserve"><path d="M2.8,17.1v-2.3H0v2.3H2.8 M2.8,5.2V2.9H0v2.3H2.8 M2.9,8.8H0v2.3h2.9V8.8 M20,11.2V8.8H6.1v2.3H20 M20,17.1v-2.3H6.1v2.3H20 M20,5.2V2.9H6.1v2.3H20z" /></svg>';
    }
}
...
if (!function_exists('iconeOrdemDescendente')) {
    ...
    {
        return '<svg height="' . $tamanho . '" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 20 20" xml:space="preserve"><g transform="translate(0,-952.36218)"><path d="M15.2,956.7l-4,3.5c-0.2,0.2-0.2,0.5-0.1,0.7c0.2,0.2,0.5,0.2,0.7,0.1l3.1-2.7v9.9c0,0.3,0.2,0.5,0.5,0.5s0.5-0.2,0.5-0.5 v-9.9l3.1,2.7c0.2,0.2,0.5,0.1,0.7-0.1c0.2-0.2,0.1-0.5-0.1-0.7l-4-3.5C15.6,956.6,15.4,956.6,15.2,956.7L15.2,956.7z" /></g><path d="M5.7,3.8l5.4,12H9.9l-1.8-3.9h-5l-1.8,3.9H0l5.4-12H5.7z M5.6,6.3l-2,4.3h3.9L5.6,6.3z" /></svg>';
    }
}
...
if (!function_exists('iconePasta')) {
    ...
    {
        return '<svg height="' . $tamanho . '" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M4 5V19H20V7H11.5858L9.58579 5H4ZM12.4142 5H21C21.5523 5 22 5.44772 22 6V20C22 20.5523 21.5523 21 21 21H3C2.44772 21 2 20.5523 2 20V4C2 3.44772 2.44772 3 3 3H10.4142L12.4142 5Z"></path></svg>';
    }
}
if (!function_exists('iconePastaAberta')) {
    // doc
    // exemplo
    // echo iconePastaAberta
    /**
    ...
    {
        return '<svg height="' . $tamanho . '" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M3 21C2.44772 21 2 20.5523 2 20V4C2 3.44772 2.44772 3 3 3H10.4142L12.4142 5H20C20.5523 5 21 5.44772 21 6V9H19V7H11.5858L9.58579 5H4V16.998L5.5 11H22.5L20.1894 20.2425C20.0781 20.6877 19.6781 21 19.2192 21H3ZM19.9384 13H7.06155L5.56155 19H18.4384L19.9384 13Z"></path></svg>';
    }
}
...
if (!function_exists('iconeEmail')) {
     ...
     * @return string SVG do icone
     */
    function iconeEmail(int $tamanho = 18): string
    {
        return '<svg height="' . $tamanho . '" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 22 20" xml:space="preserve"><path d="M1.1,0h19.8C21.5,0,22,0.5,22,1.1v17.8c0,0.6-0.5,1.1-1.1,1.1H1.1C0.5,20,0,19.5,0,18.9V1.1C0,0.5,0.5,0,1.1,0z M19.8,4.7l-8.7,7.9L2.2,4.7v13.1h17.6V4.7z M2.8,2.2l8.3,7.4l8.2-7.4H2.8z"/></svg>';
    }
}
...
if (!function_exists('iconeGoogle')) {
    ...
    {
        return '<svg height="' . $tamanho . '" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 40 40" xml:space="preserve"><path class="st0" d="M20.4,17.1V24H32c-0.5,2.9-3.5,8.6-11.6,8.6c-7,0-12.7-5.7-12.7-12.6c0-7,5.7-12.6,12.7-12.6 c4,0,6.6,1.7,8.1,3.1l5.5-5.2C30.5,2,25.9,0,20.4,0C9.1,0,0,8.9,0,20c0,11.1,9.1,20,20.4,20C32.2,40,40,31.9,40,20.5 c0-1.3-0.1-2.3-0.3-3.3H20.4L20.4,17.1z"/></svg>';
    }
}
...
if (!function_exists('iconeFacebook')) {
    ...
    {
        return '<svg height="' . $tamanho . '" id="Camada_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 20 40" xml:space="preserve"><path class="st0" d="M19.2,21h-6v19H4.3V21H0v-7.4h4.3V8.8c0-3.4,1.7-8.8,9-8.8l6.6,0v7.2h-4.8c-0.8,0-1.9,0.4-1.9,2v4.4H20L19.2,21 z"/></svg>';
    }
}
...
if (!function_exists('iconeTwitterX')) {
    // doc
    // exemplo
    // echo iconeTwitterX
    /**
     * Gera um icone do Twitter X
     *
     * @param  int    $tamanho Altura do atributo height do svg
     * @return string SVG do icone
     */
    function iconeTwitterX(int $tamanho = 15): string
    {
        return '<svg height="' . $tamanho . '" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 22 20" xml:space="preserve"><path d="M7,0H0l8.3,11l-7.8,9h2.7l6.4-7.3L15,20h7L13.4,8.5L20.8,0h-2.6l-6,6.9L7,0z M16,18L4,2h2l12,16H16z"/></svg>';
    }
}
if (!function_exists('iconeSpotify')) {
    // doc
    // exemplo
    // echo iconeSpotify
    /**
     * Gera um icone do Spotify
     *
     * @param  int    $tamanho Altura do atributo height do svg
     * @return string SVG do icone
     */
    function iconeSpotify(int $tamanho = 18): string
    {
        return '<svg height="' . $tamanho . '" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 20 20" xml:space="preserve"><path d="M10,0c5.6,0,10,4.5,10,10s-4.5,10-10,10C4.5,20,0,15.5,0,10S4.5,0,10,0z M10,2c-4.4,0-8,3.6-8,8c0,4.4,3.6,8,8,8c4.4,0,8-3.6,8-8C18,5.6,14.4,2,10,2z M13.8,14.6c-2.4-1.4-5.3-1.8-8.8-1c-0.3,0.1-0.6-0.1-0.7-0.4c-0.1-0.4,0.1-0.6,0.4-0.8c3.8-0.9,7.1-0.5,9.7,1.1c0.4,0.1,0.4,0.5,0.3,0.9C14.4,14.7,14.1,14.9,13.8,14.6z M14.8,11.9c-2.7-1.6-6.8-2.1-9.9-1.1c-0.4,0.1-0.8-0.1-1-0.5C3.8,9.9,4,9.4,4.4,9.3c3.7-1.1,8.2-0.5,11.3,1.4c0.3,0.2,0.5,0.7,0.2,1C15.6,12.1,15.1,12.2,14.8,11.9z M4.3,7.8c-0.5,0.1-1-0.2-1.2-0.6C3,6.6,3.3,6.1,3.8,6c3.5-1,9.4-0.8,13.1,1.4c0.4,0.2,0.6,0.8,0.3,1.3C17,9,16.4,9.1,15.9,8.9C12.7,7,7.4,6.8,4.3,7.8z"/></svg>';
    }
}
if (!function_exists('iconeRss')) {
    // doc
    // exemplo
    // echo iconeRss
    /**
     * Gera um icone do RSS
     *
     * @param  int    $tamanho Altura do atributo height do svg
     * @return string SVG do icone
     */
    function iconeRss(int $tamanho = 14): string
    {
        return '<svg height="' . $tamanho . '" version="1.1" id="Camada_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 20 20" xml:space="preserve"><path d="M0,15.6c2.5,0,4.4,2,4.4,4.4H0V15.6z M0,7.8c6.8,0,12.2,5.5,12.2,12.2H10c0-5.5-4.5-10-10-10V7.8z M0,0c11,0,20,9,20,20h-2.2c0-9.8-8-17.8-17.8-17.8V0z"/></svg>';
    }
}
...
if (!function_exists('iconeTikTok')) {
    // doc
    // exemplo
    // echo iconeInstagram
    /**
     ...
     * @return string SVG do icone
     */
    function iconeTikTok(int $tamanho = 17): string
    {
        return '<svg height="' . $tamanho . '" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M16 8.24537V15.5C16 19.0899 13.0899 22 9.5 22C5.91015 22 3 19.0899 3 15.5C3 11.9101 5.91015 9 9.5 9C10.0163 9 10.5185 9.06019 11 9.17393V12.3368C10.5454 12.1208 10.0368 12 9.5 12C7.567 12 6 13.567 6 15.5C6 17.433 7.567 19 9.5 19C11.433 19 13 17.433 13 15.5V2H16C16 4.76142 18.2386 7 21 7V10C19.1081 10 17.3696 9.34328 16 8.24537Z"></path></svg>';
    }
}
if (!function_exists('iconeLinkedin')) {
    // doc
    // exemplo
    // echo iconeInstagram
    /**
     ...
     * @return string SVG do icone
     */
    function iconeLinkedin(int $tamanho = 17): string
    {
        return '<svg height="' . $tamanho . '" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M18.3362 18.339H15.6707V14.1622C15.6707 13.1662 15.6505 11.8845 14.2817 11.8845C12.892 11.8845 12.6797 12.9683 12.6797 14.0887V18.339H10.0142V9.75H12.5747V10.9207H12.6092C12.967 10.2457 13.837 9.53325 15.1367 9.53325C17.8375 9.53325 18.337 11.3108 18.337 13.6245V18.339H18.3362ZM7.00373 8.57475C6.14573 8.57475 5.45648 7.88025 5.45648 7.026C5.45648 6.1725 6.14648 5.47875 7.00373 5.47875C7.85873 5.47875 8.55173 6.1725 8.55173 7.026C8.55173 7.88025 7.85798 8.57475 7.00373 8.57475ZM8.34023 18.339H5.66723V9.75H8.34023V18.339ZM19.6697 3H4.32923C3.59498 3 3.00098 3.5805 3.00098 4.29675V19.7033C3.00098 20.4202 3.59498 21 4.32923 21H19.6675C20.401 21 21.001 20.4202 21.001 19.7033V4.29675C21.001 3.5805 20.401 3 19.6675 3H19.6697Z"></path></svg>';
    }
}
if (!function_exists('iconeCompartilhar')) {
    // doc
    // exemplo
    // echo iconeCompartilhar
    /**
     * Gera um icone de compartilhar
     *
     * @param  int    $tamanho Altura do atributo height do svg
     * @return string SVG do icone
     */
    function iconeCompartilhar(int $tamanho = 17): string
    {
        return '<svg height="' . $tamanho . '" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 19 20" xml:space="preserve"><path d="M11.1,15l-4.2-2.3C6.2,13.5,5.2,14,4,14c-2.2,0-4-1.8-4-4c0-2.2,1.8-4,4-4c1.2,0,2.2,0.5,2.9,1.3L11.1,5C11,4.7,11,4.3,11,4c0-2.2,1.8-4,4-4s4,1.8,4,4s-1.8,4-4,4c-1.2,0-2.2-0.5-2.9-1.3L7.9,9C8,9.3,8,9.7,8,10s0,0.7-0.1,1l4.2,2.3c0.7-0.8,1.8-1.3,2.9-1.3c2.2,0,4,1.8,4,4s-1.8,4-4,4s-4-1.8-4-4C11,15.7,11,15.3,11.1,15z M4,12c1.1,0,2-0.9,2-2S5.1,8,4,8s-2,0.9-2,2S2.9,12,4,12z M15,6c1.1,0,2-0.9,2-2s-0.9-2-2-2s-2,0.9-2,2S13.9,6,15,6z M15,18c1.1,0,2-0.9,2-2s-0.9-2-2-2s-2,0.9-2,2S13.9,18,15,18z"/></svg>';
    }
}
...
if (!function_exists('iconeConfig')) {
    ...
    {
        return '<svg height="' . $tamanho . '" x="0px" y="0px" viewBox="0 0 35 35" xml:space="preserve"><path d="M30.4,18.3c-0.4,1.7-1.9,3-3.7,3c-1.8,0-3.4-1.3-3.7-3H2.3c-0.4,0-0.8-0.3-0.8-0.8s0.3-0.8,0.8-0.8h20.6 c0.4-1.7,1.9-3,3.7-3c1.8,0,3.4,1.3,3.7,3h2.4c0.4,0,0.8,0.3,0.8,0.8s-0.3,0.8-0.8,0.8H30.4z M26.6,15.2c-1.3,0-2.3,1-2.3,2.3 c0,1.3,1,2.3,2.3,2.3c1.3,0,2.3-1,2.3-2.3C28.9,16.2,27.9,15.2,26.6,15.2z M12.1,4.6c-0.4,1.7-1.9,3-3.7,3c-1.8,0-3.4-1.3-3.7-3 H2.3c-0.4,0-0.8-0.3-0.8-0.8S1.9,3,2.3,3h2.4C5,1.3,6.5,0,8.4,0c1.8,0,3.4,1.3,3.7,3h20.6c0.4,0,0.8,0.3,0.8,0.8s-0.3,0.8-0.8,0.8 H12.1L12.1,4.6z M8.4,1.5c-1.3,0-2.3,1-2.3,2.3c0,1.3,1,2.3,2.3,2.3c1.3,0,2.3-1,2.3-2.3C10.7,2.5,9.6,1.5,8.4,1.5z M18.9,32 c-0.4,1.7-1.9,3-3.7,3c-1.8,0-3.4-1.3-3.7-3H2.3c-0.4,0-0.8-0.3-0.8-0.8s0.3-0.8,0.8-0.8h9.2c0.4-1.7,1.9-3,3.7-3 c1.8,0,3.4,1.3,3.7,3h13.8c0.4,0,0.8,0.3,0.8,0.8S33.1,32,32.7,32H18.9z M15.2,28.9c-1.3,0-2.3,1-2.3,2.3c0,1.3,1,2.3,2.3,2.3 c1.3,0,2.3-1,2.3-2.3C17.5,29.9,16.5,28.9,15.2,28.9z" /></svg>';
    }
}
if (!function_exists('iconeOpcao')) {
    ...
    {
        return '<svg height="' . $tamanho . '" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 10 40" xml:space="preserve"><circle class="st0" cx="5" cy="5" r="5"/><circle class="st0" cx="5" cy="20" r="5"/><circle class="st0" cx="5" cy="35" r="5"/></svg>';
    }
}
...
if (!function_exists('iconeNotificacao')) {
    ...
    {
        return '<svg height="' . $tamanho . '" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 30 30" xml:space="preserve"><path class="st0" d="M12.55,3.58c-4.23,1.09-7.36,4.93-7.36,9.51v6.54c0,0.6-0.49,1.09-1.09,1.09c-1.21,0-2.18,0.98-2.18,2.18 v1.64c0,0.3,0.24,0.54,0.55,0.54h25.09c0.3,0,0.55-0.25,0.55-0.54v-1.64c0-1.2-0.98-2.18-2.18-2.18c-0.6,0-1.09-0.49-1.09-1.09 v-6.54c0-4.57-3.13-8.42-7.36-9.51V2.46C17.45,1.1,16.36,0,15,0c-1.35,0-2.45,1.1-2.45,2.46V3.58z M11.18,26.18h7.64 c0,2.11-1.71,3.82-3.82,3.82S11.18,28.29,11.18,26.18z"/></svg>';
    }
}
...
if (!function_exists('iconeFlechaCima')) {
    ...
    {
        return '<svg height="' . $tamanho . '" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 38 50" xml:space="preserve"><path d="M20.8,48.1V6.4L34.6,20c0.7,0.8,1.9,0.8,2.7,0.1c0.8-0.7,0.8-1.9,0.1-2.7l-0.1-0.1l-17-16.8c-0.7-0.7-1.9-0.7-2.7,0 l-17,16.8C-0.2,18-0.2,19.2,0.5,20c0.7,0.8,1.9,0.8,2.7,0.1L3.3,20L17,6.4v41.7c0,1,0.9,1.9,1.9,1.9C20,50,20.8,49.2,20.8,48.1z"/></svg>';
    }
}
if (!function_exists('iconeFlechaBaixo')) {
    ...
    {
        return '<svg height="' . $tamanho . '" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 38 50" xml:space="preserve"><path d="M17.1,1.8v41.7L3.3,29.9c-0.7-0.8-1.9-0.8-2.7-0.1c-0.8,0.7-0.8,1.9-0.1,2.7l0.1,0.1l17,16.8c0.7,0.7,1.9,0.7,2.7,0l17-16.8 c0.8-0.7,0.8-1.9,0.1-2.7c-0.7-0.8-1.9-0.8-2.7-0.1l-0.1,0.1L20.9,43.5V1.8c0-1-0.9-1.9-1.9-1.9C17.9-0.1,17.1,0.7,17.1,1.8z"/></svg>';
    }
}
...
if (!function_exists('iconeFlechaDireita')) {
    ...
    {
        return '<svg height="' . $tamanho . '" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 50 38" xml:space="preserve"><path d="M1.9,20.8h41.7L30,34.6c-0.8,0.7-0.8,1.9-0.1,2.7c0.7,0.8,1.9,0.8,2.7,0.1l0.1-0.1l16.8-17c0.7-0.7,0.7-1.9,0-2.7l-16.8-17 C32-0.2,30.8-0.2,30,0.5c-0.8,0.7-0.8,1.9-0.1,2.7L30,3.3L43.6,17H1.9c-1,0-1.9,0.9-1.9,1.9C0,20,0.8,20.8,1.9,20.8z"/></svg>
        ';
    }
}
if (!function_exists('iconeSetaBaixo')) {
    ...
    {
        return '<svg height="' . $tamanho . '" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 30 16" xml:space="preserve"><g transform="translate(0,-952.36218)"><path d="M15.3,968.3c0.6-0.1,1.1-0.3,1.6-0.7l12.1-10.2c1.2-1,1.4-2.8,0.4-4c-1-1.2-2.8-1.4-4-0.4c0,0-0.1,0.1-0.1,0.1L15,961.8 l-10.2-8.7c-1.2-1.1-3-1-4.1,0.2s-1,3,0.2,4c0.1,0,0.1,0.1,0.1,0.1l12.1,10.2C13.7,968.2,14.5,968.4,15.3,968.3L15.3,968.3z"/></g></svg>';
    }
}
if (!function_exists('iconeSetaCima')) {
    ...
    {
        return '<svg height="' . $tamanho . '" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 30 16" xml:space="preserve"><g transform="translate(0,-952.36218)"><path d="M14.7,952.4c-0.6,0.1-1.1,0.3-1.6,0.7L1.1,963.3c-1.2,1-1.4,2.8-0.4,4c1,1.2,2.8,1.4,4,0.4c0,0,0.1-0.1,0.1-0.1l10.2-8.7 l10.2,8.7c1.2,1.1,3,1,4.1-0.2s1-3-0.2-4c0,0-0.1-0.1-0.1-0.1L16.9,953C16.3,952.5,15.5,952.3,14.7,952.4L14.7,952.4z"/></g></svg>';
    }
}
if (!function_exists('iconeSetaEsquerda')) {
    ...
    {
        return '<svg height="' . $tamanho . '" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 16 30" xml:space="preserve"><g transform="translate(0,-952.36218)"><path d="M0,967.6c0.1,0.6,0.3,1.2,0.7,1.6l10.2,12.1c1,1.2,2.8,1.4,4,0.4c1.2-1,1.4-2.8,0.4-4c0,0-0.1-0.1-0.1-0.1l-8.7-10.2 l8.7-10.2c1.1-1.2,1-3-0.2-4.1s-3-1-4,0.2c0,0-0.1,0.1-0.1,0.1L0.7,965.5C0.2,966.1-0.1,966.8,0,967.6L0,967.6z"/></g></svg>';
    }
}
if (!function_exists('iconeSetaDireita')) {
    ...
    {
        return '<svg height="' . $tamanho . '" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 16 30" xml:space="preserve"><g transform="translate(0,-952.36218)"><path d="M16,967.1c-0.1-0.6-0.3-1.2-0.7-1.6L5.1,953.4c-1-1.2-2.8-1.4-4-0.4c-1.2,1-1.4,2.8-0.4,4c0,0,0.1,0.1,0.1,0.1l8.7,10.2 l-8.7,10.2c-1.1,1.2-1,3,0.2,4.1s3,1,4-0.2c0,0,0.1-0.1,0.1-0.1l10.2-12.1C15.8,968.6,16.1,967.9,16,967.1L16,967.1z"/></g></svg>';
    }
}
...
if (!function_exists('iconeOutro')) {
    ...
    {
        return '<svg height="' . $tamanho . '" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 40 40" xml:space="preserve"><path class="st0" d="M12.7,0H5.5C2.4,0,0,2.4,0,5.5v7.3c0,3,2.4,5.5,5.5,5.5h7.3c3,0,5.5-2.4,5.5-5.5V5.5C18.2,2.4,15.7,0,12.7,0z M14.5,12.7c0,1-0.8,1.8-1.8,1.8H5.5c-1,0-1.8-0.8-1.8-1.8V5.5c0-1,0.8-1.8,1.8-1.8h7.3c1,0,1.8,0.8,1.8,1.8V12.7z"/><path class="st0" d="M12.7,21.8H5.5c-3,0-5.5,2.4-5.5,5.5v7.3c0,3,2.4,5.5,5.5,5.5h7.3c3,0,5.5-2.4,5.5-5.5v-7.3 C18.2,24.3,15.7,21.8,12.7,21.8z M14.5,34.5c0,1-0.8,1.8-1.8,1.8H5.5c-1,0-1.8-0.8-1.8-1.8v-7.3c0-1,0.8-1.8,1.8-1.8h7.3 c1,0,1.8,0.8,1.8,1.8V34.5z"/><path class="st0" d="M34.5,21.8h-7.3c-3,0-5.5,2.4-5.5,5.5v7.3c0,3,2.4,5.5,5.5,5.5h7.3c3,0,5.5-2.4,5.5-5.5v-7.3 C40,24.3,37.6,21.8,34.5,21.8z M36.4,34.5c0,1-0.8,1.8-1.8,1.8h-7.3c-1,0-1.8-0.8-1.8-1.8v-7.3c0-1,0.8-1.8,1.8-1.8h7.3 c1,0,1.8,0.8,1.8,1.8V34.5z"/><path class="st0" d="M34.5,0h-7.3c-3,0-5.5,2.4-5.5,5.5v7.3c0,3,2.4,5.5,5.5,5.5h7.3c3,0,5.5-2.4,5.5-5.5V5.5C40,2.4,37.6,0,34.5,0 z M36.4,12.7c0,1-0.8,1.8-1.8,1.8h-7.3c-1,0-1.8-0.8-1.8-1.8V5.5c0-1,0.8-1.8,1.8-1.8h7.3c1,0,1.8,0.8,1.8,1.8V12.7z"/></svg>';
    }
}
...
if (!function_exists('iconeSair')) {
    ...
    {
        return '<svg height="' . $tamanho . '" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32 32" xml:space="preserve"><path d="M11,29H3c-0.6,0-1-0.4-1-1V4c0-0.6,0.4-1,1-1h8c0.6,0,1,0.4,1,1s-0.4,1-1,1H4v22h7c0.6,0,1,0.4,1,1S11.6,29,11,29z M20,25  c-0.3,0-0.5-0.1-0.7-0.3c-0.4-0.4-0.4-1,0-1.4l6.3-6.3H8c-0.6,0-1-0.4-1-1s0.4-1,1-1h17.6l-6.3-6.3c-0.4-0.4-0.4-1,0-1.4  s1-0.4,1.4,0l8,8c0.1,0.1,0.2,0.2,0.2,0.3c0,0.1,0.1,0.2,0.1,0.4l0,0c0,0,0,0,0,0l0,0c0,0.1,0,0.3-0.1,0.4c0,0.1-0.1,0.2-0.2,0.3  l-8,8C20.5,24.9,20.3,25,20,25z"/></svg>';
    }
}
...
if (!function_exists('iconeDrag')) {
    ...
    {
        return '<svg height="' . $tamanho . '" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 40 21" xml:space="preserve"><g><path class="st0" d="M37.1,21H2.9C1.3,21,0,19.7,0,18.1s1.3-2.9,2.9-2.9h34.3c1.6,0,2.9,1.3,2.9,2.9S38.7,21,37.1,21z M37.1,5.7 H2.9C1.3,5.7,0,4.4,0,2.9S1.3,0,2.9,0h34.3C38.7,0,40,1.3,40,2.9S38.7,5.7,37.1,5.7z"/></g></svg>';
    }
}
if (!function_exists('iconeCopiar')) {
    ...
    {
        return '<svg height="' . $tamanho . '" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 30 27" xml:space="preserve"><path d="M16.2,27c2.5,0,4.6-2,4.6-4.5v-2.1h4.6c2.5,0,4.6-2,4.6-4.5V4.5C30,2,27.9,0,25.4,0H13.8c-2.5,0-4.6,2-4.6,4.5v2.1H4.6c-2.5,0-4.6,2-4.6,4.5v11.4C0,25,2.1,27,4.6,27H16.2z M11.7,4.5c0-1.1,0.9-2,2.1-2h11.7c1.2,0,2.1,0.9,2.1,2v11.4c0,1.1-0.9,2-2.1,2h-4.6v-6.9c0-2.5-2.1-4.5-4.6-4.5h-4.6V4.5z M2.5,22.5V11.1c0-1.1,0.9-2,2.1-2h11.7c1.2,0,2.1,0.9,2.1,2v11.4c0,1.1-0.9,2-2.1,2H4.6C3.4,24.5,2.5,23.6,2.5,22.5z"/></svg>';
    }
}
...
if (!function_exists('iconeCheck')) {
    ...
    {
        return '<svg height="' . $tamanho . '" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 100 100" enable-background="new 0 0 100 100" xml:space="preserve"><path d="M91,12.2c-4.2-3-10-1.9-13,2.3L42.1,65.8L20.9,44.6c-3.6-3.6-9.6-3.6-13.2,0c-3.6,3.6-3.6,9.6,0,13.2l29,29  c1.8,1.8,4.2,2.7,6.6,2.7c0,0,0,0,0.1,0c0,0,0.7,0,0.9,0c2.6-0.2,5.1-1.6,6.8-3.9l42.3-60.4C96.3,20.9,95.2,15.1,91,12.2z"/></svg>';
    }
}
...
if (!function_exists('iconeAnexo')) {
    ...
    {
        return '<svg height="' . $tamanho . '" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 18 20" xml:space="preserve"><path d="M12.2,6l-5.8,5.9C6,12.3,6,13,6.4,13.4c0.4,0.4,1,0.4,1.4,0l5.8-5.9c1.2-1.2,1.2-3.2,0-4.4c-1.2-1.2-3.1-1.2-4.3,0L3.5,9c-2,2-2,5.4,0,7.4c2,2,5.2,2,7.2,0l5.8-5.9l1.4,1.5l-5.8,5.9c-2.8,2.9-7.3,2.9-10.1,0s-2.8-7.5,0-10.4l5.8-5.9c2-2,5.2-2,7.2,0s2,5.4,0,7.4l-5.8,5.9c-1.2,1.2-3.1,1.2-4.3,0c-1.2-1.2-1.2-3.2,0-4.4l5.8-5.9L12.2,6z"/></svg>';
    }
}
...
if (!function_exists('iconeMais')) {
    ...
    {
        return '<svg height="' . $tamanho . '" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 40 40" xml:space="preserve"><path d="M36.8,16.8H23.2V3.2C23.2,1.4,21.8,0,20,0c-1.7,0-3.2,1.4-3.2,3.2v13.7H3.2C1.4,16.8,0,18.2,0,20c0,0.9,0.3,1.6,0.9,2.2c0.6,0.6,1.3,0.9,2.2,0.9h13.7v13.7c0,0.9,0.3,1.6,0.9,2.2c0.6,0.6,1.3,0.9,2.2,0.9c1.7,0,3.2-1.4,3.2-3.2V23.2h13.7c1.7,0,3.2-1.4,3.2-3.2C40,18.3,38.6,16.8,36.8,16.8z"/></svg>';
    }
}
if (!function_exists('iconeMenos')) {
    ...
    {
        return '<svg height="' . $tamanho . '" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 40 10" xml:space="preserve"><path d="M35,10H5c-2.7,0-5-2.2-5-5v0c0-2.7,2.2-5,5-5h30c2.8,0,5,2.2,5,5v0C40,7.8,37.8,10,35,10z"/></svg>';
    }
}
if (!function_exists('iconePlay')) {
    ...
    {
        return '<svg height="' . $tamanho . '" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 40 40" xml:space="preserve"><path class="st0" d="M20,0C8.95,0,0,8.95,0,20s8.95,20,20,20s20-8.95,20-20S31.05,0,20,0L20,0z M28.19,20.67l-12.66,9.21c-0.26,0.19-0.58,0.21-0.87,0.07s-0.46-0.42-0.46-0.74l0-18.43c0-0.32,0.17-0.6,0.46-0.74c0.29-0.15,0.61-0.12,0.87,0.07l12.66,9.21c0.22,0.16,0.34,0.4,0.34,0.67C28.54,20.28,28.42,20.51,28.19,20.67L28.19,20.67z"/></svg>';
    }
}
if (!function_exists('iconePause')) {
    ...
    {
        return '<svg height="' . $tamanho . '" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 40 40" xml:space="preserve"><path d="M40,20c0,11-9,20-20,20S0,31,0,20S9,0,20,0S40,9,40,20L40,20z M10.4,9.8c0-1.1,0.9-1.9,1.9-1.9h4.2 c1.1,0,1.9,0.9,1.9,1.9v20.3c0,1.1-0.9,1.9-1.9,1.9h-4.2c-1.1,0-1.9-0.9-1.9-1.9L10.4,9.8z M23.5,7.9c-1.1,0-1.9,0.9-1.9,1.9v20.3 c0,1.1,0.9,1.9,1.9,1.9h4.2c1.1,0,1.9-0.9,1.9-1.9V9.8c0-1.1-0.9-1.9-1.9-1.9H23.5z"/></svg>';
    }
}
...
if (!function_exists('iconeRelogio')) {
    ...
    {
        return '<svg height="' . $tamanho . '" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 30 30" xml:space="preserve"><path d="M15,30C6.7,30,0,23.3,0,15C0,6.7,6.7,0,15,0c8.3,0,15,6.7,15,15C30,23.3,23.3,30,15,30z M15,27c6.6,0,12-5.4,12-12c0-6.6-5.4-12-12-12C8.4,3,3,8.4,3,15C3,21.6,8.4,27,15,27z M16.5,15h6v3h-9V7.5h3V15z"/></svg>';
    }
}

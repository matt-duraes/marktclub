...
Route
    ...
    ::controller(AppController::class)::grupo(function () {
        ...
        Route::action('classe')::request('*')::post('/app/classe/{app}');
    ...
    ::grupo(function () {
        Route
            ...
            ::rotaNaoUnica()
            ::request([
                'local_principal', 'local_secundario', 'vinculo', 'pagina', '!quantidade', '!pesquisa', '!tipo'
            ])
        ...
        Route
            ...
            ::rotaNaoUnica()
            ::request([
                'local_principal', 'local_secundario', 'vinculo', 'titulo', 'nome', 'cpf', 'tipo', 'valor',
                'whatsapp', 'principal'
            ])

...
final class Link
{
    ...
    private function montarLinkPadrao(string $linkGeral, string $link)
    {
        if ($link == '{{LINK}}') {
    ...
    private function montarLinkParaDefine(string $linkGeral, string $link)
    {
        return str_replace(
            ['{{LINK}}', '{{LINK_PADRAO}}'],

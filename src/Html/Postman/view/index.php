    ...
    <div class="bloco_modelo_geral display_none">
        ...
        <div class="bloco_requisicao ativo" id="bloco_requisicao_modelo">
            ...
            <div class="bloco_resposta_lista">
                <div class="titulo"><p>Requisição:</p><span class="bloco_tempo_resposta"></span><span class="bloco_codigo_html"></span></div>
                <ul class="bloco_resposta_botao display_none">
                    ...
                    <li class="tipo_resposta botao_resposta_header" data-id="bloco_resposta_header">Header</li>
                </ul>
                ...
                <pre class="bloco_resposta bloco_resposta_header"></pre>
            </div>
        </div>
    </div>
</div>

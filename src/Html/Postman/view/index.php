...
<div id="site">
    ...
    <div class="bloco_modelo_geral display_none">
        <!-- GRUPO PADRAO -->
        <div class="grupo novo fechado" id="bloco_grupo_modelo">
            <div class="nome hover">
                <i class="pasta pasta_aberta"><?= iconePasta(20) ?></i>
                <i class="pasta pasta_fechada"><?= iconePastaAberta(20) ?></i>
                <p class="nome_grupo display_none"></p>
                <input type="text" class="nome_grupo input_nome" placeholder="Nome do grupo">
                <i class="opcao botao_opcao_grupo"><?= iconeOpcao() ?></i>
            </div>
            <div class="request_vazio">Sem requisição</div>
        </div>
        <!-- REQUEST PADRAO -->
        <div class="request" id="bloco_requisicao_modelo">
            <div class="metodo GET">GET</div>
            <div class="uri display_none"></div>
            <input name="uri" class="input_uri" value="" placeholder="Nome da rota">

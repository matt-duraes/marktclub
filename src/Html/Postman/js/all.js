...
window.addEventListener('load', () => {
    ...
    // const blocoRequisicaoLista = document.getElementById('bloco_requisicao_lista');
    ...
    //         mostrarBotaoSalvar(e.target.closest('.bloco_requisicao'));
    //     }
    // });
    ...
    //     const bloco = document.querySelector('#bloco_requisicao_' + aba.getAttribute('data-id'));
    ...
    // };
    // const abrirRota = id => {
    //     const blocoExiste = blocoRequisicaoLista.querySelector('#' + id + '_requisicao');
    //     const blocoAtivo = blocoRequisicaoLista.querySelector('.bloco_requisicao.ativo');
    ...
    //     blocoRequisicaoLista.appendChild(clone);
    //     blocoRequisicaoLista.classList.remove('display_none');
    //     blocoVazio.classList.add('display_none');
    //     const existeMenu = document.querySelector('.bloco_menu .requisicao[data-id="' + id + '"]');
    ...
    //     }
    //     buscarDadoRequisicao(id, clone);
    // };
    // const buscarDadoRequisicao = async (id, bloco) => {

        ...
        return new Promise(resolve => {
            ...
            BODY.insertAdjacentHTML(
                ...
                <div id="fw_historico" class="fw_historico_hide">
                    ...
                    <div class="fw_historico_pausar_continuar" id="fw_historico_pausar"><svg height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M10,0C4.5,0,0,4.5,0,10s4.5,10,10,10,10-4.5,10-10S15.5,0,10,0ZM8.2,14.9h-2V5h2v10ZM14.2,14.9h-2V5h2v10Z"/></svg></div>
                    <div class="fw_historico_pausar_continuar fw_historico_hide" id="fw_historico_continuar"><svg height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M10,0C4.5,0,0,4.5,0,10s4.5,10,10,10,10-4.5,10-10S15.5,0,10,0h0ZM14.1,10.3l-6.3,4.6c-.1,0-.3.1-.4,0s-.2-.2-.2-.4V5.4c0-.2,0-.3.2-.4.1,0,.3,0,.4,0l6.3,4.6c.1,0,.2.2.2.3,0,.1,0,.3-.2.3h0Z"/></svg></div>

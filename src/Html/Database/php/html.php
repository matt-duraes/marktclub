    ...
    <div id="site">
        ...
        <?php if ($lista) : ?>
            ...
            <form action="<?= LINK; ?>/__base" method="post" class="lista">
                ...
                <div class="todo">
                    <input type="checkbox" name="marcar_todos" id="marcar_todos" value="marcar">
                    <label for="marcar_todos">Marcar/Desmarcar todos.</label>
                </div>
                ...
                <div class="conteudo">
                    ...
                    <?php foreach ($lista as $val) : ?>
                        <div class="bloco">
                            <input type="checkbox" class="input_tabela" name="tabela[]" id="id_<?= $val; ?>" value="<?= $val; ?>">

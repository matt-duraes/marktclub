<div id="bloco_historico_view">
    ...
    <form action="" class="add form_geral" id="bloco_historico_add">
        ...
        <figure style="background-image: url(<?= USUARIO_IMAGEM ?>);"></figure>
        <?= formTextarea(name: '', label: '', placeholder: 'Digite sua mensagem', enter: false, id: 'input_historico_mensagem') ?>

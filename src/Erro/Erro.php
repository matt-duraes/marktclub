...
final class Erro extends \Exception
{
     ...
     * @param bool|int   $traceRemover Se true, vai remover o primeiro arquivo do trace, se
     *                                 int, vai remover  a quantidade informada
     */

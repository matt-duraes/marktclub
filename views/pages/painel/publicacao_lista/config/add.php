...
$Painel = new PainelConfig\Add(app: 'publicidade_lista', acao: $acao);
...
$Painel->coluna(callback: function () use ($Painel) {
    $Painel->fieldset('Lista de texto', function () use ($Painel) {
        $Painel
            ->indiceValor(
                name: 'lista',
                placeholder: ['Digite um indice', 'Digite um valor'],
                ordem: true
            );
    });
});

...
window.addEventListener('load', () => {
    ...
    if (botaoDeletar) {
        botaoDeletar.addEventListener('click', async () => {
            ...
            if (
                await Alerta.confirmar('Deletar álbuns!', 'Tem certeza que deseja deletar os álbuns selecionados?', '!')
            ) {

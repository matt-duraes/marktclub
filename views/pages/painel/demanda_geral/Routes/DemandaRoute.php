...
Route
    ...
    ::nome('demanda')
    ::controller(Painel\DemandaGeral\Controllers\DemandaController::class)
    ::grupo(function () {
        Route
            ::nome('quadro')
            ::middleware(
    ...
    ::controller(Painel\DemandaGeral\Controllers\SprintController::class)
    ::grupo(function () {
        Route
            ::nome('sprintAtiva')

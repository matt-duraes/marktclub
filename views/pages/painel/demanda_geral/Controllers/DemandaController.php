...
namespace Painel\DemandaGeral\Controllers;
...
use Painel\DemandaGeral\Models\SorteioModel;
use Painel\DemandaGeral\Models\CriarBugModel;
use Painel\DemandaGeral\Models\CriarOutroModel;
use Painel\DemandaGeral\Models\CriarBrindeModel;
use Painel\DemandaGeral\Models\CriarEventoModel;
use Painel\DemandaGeral\Models\CriarClienteModel;
use Painel\DemandaGeral\Models\TarefaSalvarModel;
use Painel\DemandaGeral\Models\CriarCampanhaModel;
use Painel\DemandaGeral\Models\CriarAuditoriaModel;
use Painel\DemandaGeral\Models\CriarIndicacaoModel;
use Painel\DemandaGeral\Models\CriarAssociacaoModel;
use Painel\DemandaGeral\Models\CriarAutoindicacaoModel;
use App\Classes\DemandaTarefa\Tipo as DemandaTarefaTipo;
use Painel\DemandaGeral\Models\CriarCotacaoProdutoModel;
use Painel\DemandaGeral\Models\CriarCotacaoAutomovelModel;
...
final class DemandaController extends Controller
{
    ...
    public function quadro()
    {
        ...
        return $this->listar('Sprint', Area::TECNOLOGIA, $quadro, menu: 'quadro');
    }
    ...
    private function listar($titulo, $area, $quadro, $visualizacao = 'quadro', $menu = null)
    {
        $empresa = $this->Api
    ...
    {
        return view('painel.demanda_geral.demanda', [
    ...
    public function demandaSalvar(string $area)
    {
        ...
        return view('painel.demanda_geral.demanda-salvar', [
    ...
    public function demandaEditar(string $id)
    {
        ...
        return view('painel.demanda_geral.demanda-editar', [
            'r'                 => $demanda->dado,
            'empresa'           => $empresa['dado'] ?? [],
            'equipe'            => $equipe['dado'] ?? [],

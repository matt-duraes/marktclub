...
return [
    'salvar' => [
        ...
        'contato_chat', 'home_noticia_principal', 'home_noticia_lista', 'home_parceiro', 'home_video', 'home_galeria',
        'login_texto', 'login_link', 'clube_link', 'rede_header', 'rede_footer', 'rss', 'cor_texto', 'status',

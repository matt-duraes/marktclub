...
INSERT INTO `users` (`id`, `name`, `email`, `password`, `cpf`, `token`, `permissao`, `status`) VALUES (NULL, 'admin', 'marktclub@gmail.com', '$2y$10$OyY0BRwPCEBDxWVVkfCyAeUU/09SNXN40zOeFdfMTVYeEpwVzvEjG', '07385656165', '', 'login,usuario_add,usuario_editar,usuario_deletar', '1');

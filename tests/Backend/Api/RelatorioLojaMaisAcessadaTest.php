...
final class RelatorioLojaMaisAcessadaTest extends Tests
{
    use RelatorioTrait;

    protected string $uri = '/relatorio/loja-mais-acessada';
    ...
    public function buscarAsDuasEmpresasTest()
    {
        ...
        $dispositivosSoma = $this->pegarSoma('loja');

        foreach ($dado as $k => $d) {
            $this->checkIgual($d['total'], $dispositivosSoma[$d['loja']]);
        }

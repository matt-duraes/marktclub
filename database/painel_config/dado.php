...
return [
    [
        ...
        'titulo'            => 'Padrao',
        'permissao'         => [
            "usuario_dependente_index","usuario_dependente_add","usuario_dependente_deletar","usuario_indicacao_index","usuario_indicacao_visualizar","usuario_indicacao_status","usuario_lead_index","usuario_lead_visualizar","usuario_lead_status","usuario_equipe_index","usuario_equipe_add","usuario_equipe_editar","usuario_equipe_deletar","usuario_equipe_permissao","relatorio_acesso_index","relatorio_usuario_index","tabela_usuario_salvar","tabela_usuario_bloquear","tabela_historico_index","usuario_cliente_index","usuario_cliente_visualizar","usuario_cliente_add","usuario_cliente_editar","usuario_cliente_download"
        ],

...
-----END PUBLIC KEY-----',
        ...
        'client_id'          => '6391793193-szIaoukiIh$62SH#mIPPYkrnn$ylHL2Li3*T4SMQyhv1UUeiRxA*%8yOwdSt1BkBEPTI#%ODLUa.painel.local',
        'client_id_fake'     => '6391793193-szIaoukiIh$62SH#mIPPYkrnn$ylHL2Li3*T4SMQyhv1UUeiRxA*%8yOwdSt1BkBEPTI#%ODLUa.painel.local',
        'audience'           => 'painel',
        'authorization_code' => null,
        'client_credentials' => '1',
        'refresh_token'      => '1',
        'redirect_uri'       => '["painel.local"]',
...
-----END PUBLIC KEY-----',
        ...
        'client_id'          => '5537870833-uudRDzy0PsFqZ$Hw9#5amskM4ukDM#AGn7omv4jUAmN6Q0ib9O2awBkyOo0ywp6Qdcd4NlcqdZ*l.clube.local',
        'client_id_fake'     => '5537870833-uudRDzy0PsFqZ$Hw9#5amskM4ukDM#AGn7omv4jUAmN6Q0ib9O2awBkyOo0ywp6Qdcd4NlcqdZ*l.clube.local',
        'audience'           => 'clube',
        'authorization_code' => '2',
        'client_credentials' => 1,
        'refresh_token'      => '1',
        'redirect_uri'       => '["clube.local","clube.youhuul.com.br"]',
        'scope_permitido'    => Scope::TUDO,
        'campo_permitido'    => '{"usuario:salvar":["nome","cpf","email_trabalho","senha","telefone_celular"],"usuario:atualizar":["nome","cpf","email_trabalho","senha","telefone_celular"],"usuario:buscar":["uuid","nome","cpf"],"usuario:listar":["uuid","nome","cpf"]}',
        'tempo_vida'         => '50000',
...
-----END PUBLIC KEY-----',
        ...
        'client_id'          => '8019373376-0PIohZFZGh1$Jjn%AVxnik*itnXWiea%CvQQuRm2%TGmmuXsHRGz!Sk7oJYaS0xQzJri8C!xDIa.clube.local',
        'client_id_fake'     => '8019373376-0PIohZFZGh1$Jjn%AVxnik*itnXWiea%CvQQuRm2%TGmmuXsHRGz!Sk7oJYaS0xQzJri8C!xDIa.clube.local',
        'audience'           => 'login',
        'authorization_code' => null,
        'client_credentials' => 1,
        'refresh_token'      => '1',
        'redirect_uri'       => '["clube.local"]',
        'scope_permitido'    => Scope::TUDO,
        'campo_permitido'    => '{"usuario:salvar":["nome","cpf","email_trabalho","senha","telefone_celular"],"usuario:atualizar":["nome","cpf","email_trabalho","senha","telefone_celular"],"usuario:buscar":["uuid","nome","cpf"],"usuario:listar":["uuid","nome","cpf"]}',
        'tempo_vida'         => '300',
        'data_criacao'       => date('Y-m-d H:i:s'),
